...
def load_visa(category, k_shot, experiment_indx, phase):
    ...
    #         train_tot_types = load_phase(train_img_path, ground_truth_path)
    #
    #     training_indx = torch.randint(0, len(train_img_tot_paths), (k_shot,))
    #     print(training_indx)
    #
    #     for i in training_indx:
    #         img_path, gt_path, label, defect_type = train_img_tot_paths[i], train_gt_tot_paths[i], train_tot_labels[i], \
    #             train_tot_types[i]
