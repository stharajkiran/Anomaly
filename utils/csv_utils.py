...
def save_metric(metrics, total_classes, class_name, dataset, csv_path, scores_info, scores_dir):
    if dataset != 'mvtec':
    ...
    class_dir = os.path.join(scores_dir, class_name)
    if not os.path.exists(class_dir):
        os.makedirs(class_dir, exist_ok=True)

    scores_path = os.path.join(class_dir, "scores.pkl")
